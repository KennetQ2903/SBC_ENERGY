...
function borrarSeachBar(){
document.getElementById('searchBarSuministrosInput').value = "";
}


// Funcion para borrar el buscador de suministros
window.addEventListener('click', function(e){
if(document.getElementById('searchBarSuministrosInput').contains(e.target)){
	if(document.getElementById('searchBarSuministrosInput').value == "Buscar en..."){
		document.getElementById('searchBarSuministrosInput').value = "";
	}
}
if(!document.getElementById('searchBarSuministrosInput').contains(e.target)){
	if(document.getElementById('searchBarSuministrosInput').value == ""){
		document.getElementById('searchBarSuministrosInput').value = "Buscar en...";
	}
}
});

// Funcion para borrar el buscador de Bancos
window.addEventListener('click', function(e){
if(document.getElementById('searchBarBancosInput').contains(e.target)){
	if(document.getElementById('searchBarBancosInput').value == "Buscar en..."){
		document.getElementById('searchBarBancosInput').value = "";
	}
}
if(!document.getElementById('searchBarBancosInput').contains(e.target)){
	if(document.getElementById('searchBarBancosInput').value == ""){
		document.getElementById('searchBarBancosInput').value = "Buscar en...";
	}
}
});
